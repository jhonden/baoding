		...
		<div class="ab-main clearfix">
			...
			<div class="left fl">
				...
				<ul class="left-nav">
					...
					<li><a title="联系方式" class="current" href="contact_way"
				...
				<div class="right-cen">
					<p style="text-align: center;">
						<span style="font-size: 18px;"><strong><span
								style="color: rgb(0, 176, 240);">专项建设基金联系方式</span></strong></span>
					</p>
					<p style="text-align: center;">
						<span style="color: rgb(0, 0, 0);">付闳波 &nbsp;总经理 &nbsp;
							&nbsp;18980826888</span><br>
					</p>
					<p style="text-align: center;">
						<span style="color: rgb(0, 0, 0);">李 &nbsp;航 &nbsp;副总经理
							&nbsp;13982009689</span>
					</p>
					<p style="text-align: center;">
						<span style="color: rgb(0, 0, 0);">付 &nbsp;浩 &nbsp;副总经理
							&nbsp;15982825117</span>
					</p>
					<p style="text-align: center;">
						<span style="color: rgb(0, 0, 0);">赵遵生 &nbsp; &nbsp; &nbsp;
							&nbsp; &nbsp; &nbsp;13183866467</span>
					</p>
					<p style="text-align: center;">
						<span style="color: rgb(0, 0, 0);">王 &nbsp;娴 &nbsp; &nbsp;
							&nbsp; &nbsp; &nbsp; &nbsp;13882220682</span>
					</p>
					<p>
						<br>

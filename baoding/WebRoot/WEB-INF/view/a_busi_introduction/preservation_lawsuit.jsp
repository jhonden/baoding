        ...
        <div class="right fr">
            ...
            <div class="right-cen">
                <table>
                    <tbody>
                    <tr class="firstRow">
                        <td width="387" valign="top"><img src="../comm/image/6356754398825000001566369.jpg" title="" alt="" width="314" height="203" border="0" vspace="0" style="width: 314px; height: 203px;"></td>
                        <td width="1257" valign="top" style="word-break: break-all;"><p style="text-indent: 2em;"><br></p>
                            <script id="web_mm" src="../comm/image/6356909993549562258167943.bmp"></script>
